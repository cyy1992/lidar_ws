...
extern const string pointCloudTopic = "/scan";
extern const string imuTopic = "/jzhw/imu";
...
extern const float ang_res_x = 0.17857143;
...
// Usage of Ouster imu data is not supported yet, please just publish point
// cloud data
// Ouster OS1-16
// extern const int N_SCAN = 16;
...
extern const float edgeThreshold = 0.02;
extern const float surfThreshold = 0.1;
extern const float nearestFeatureSearchSqDist_ = 25;
...
extern const int historyKeyframeSearchNum = 25; // 2n+1 number of hostory key
                                                // frames will be fused into a
